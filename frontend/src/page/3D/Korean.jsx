...
import { geometry, material } from './Kore'
...
export default function Korean() {
  return (
    ...
    <Fragment>
      ...
      <Canvas dpr={[1, 1.5]} shadows camera={{ position: [0, 0, 100], fov: 30 }} style={{width:"auto",height:"700px"}}>
        <fog attach="fog" args={['#11ffee00', 100, 150]} />
        <color attach="background" args={['#11ffee00']} />
        <spotLight
          penumbra={1}
          angle={0.35}
          castShadow
